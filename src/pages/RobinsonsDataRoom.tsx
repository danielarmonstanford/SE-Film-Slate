      ...
      <div className="w-full max-w-[480px]">
        ...
        <div className="mb-2">
          ...
          <p className="text-xs text-[var(--text-72)] leading-relaxed mb-6">
            Full investor deck, cast options, comparables, and supporting materials. Access code required.
          </p>
        </div>
        ...
        {!granted ? (
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <p className="text-[9px] text-[var(--text-25)] text-center leading-relaxed pt-2">
              ...
              <a
                href="mailto:Daniel@StanfordEmporium.com?subject=The Robinsons Data Room Access Request"
...
export default RobinsonsDataRoom;
