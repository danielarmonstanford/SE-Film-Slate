...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    status: 'CO-PRODUCTION FINANCING — ACTIVE',
    statusColor: 'var(--red-urgent)',
    deckUrl: 'https://drive.google.com/file/d/1_placeholder_deck_link/view?usp=sharing',
    previewImages: [
      '/400xy-art.jpg',
    ...
    positioning: 'Strategic Co-Production. 50% participation available on secured tranche. Tax-credit-backed capital preferred.',
    budgetRange: 'Strategic Co-Production',
    equityAvailable: '50% participation on tax-credit-secured tranche',
    ...
    marketPositioning: 'Preferred capital: tax-credit-backed / low-risk structured finance. Serious inquiries only.',
    audience: 'Sci-fi fans, international cinema lovers, and tech-savvy audiences.',
    timingRelevance: 'Multi-territory treaty production with built-in market access across Canada, China, and Greece.',
    commercialStrengths: [
