...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    description: 'A finished, delivered Guy Ritchie action thriller with a $2M Film Finance & Equity Access opportunity offering lifetime profit participation. Lionsgate releasing on 3,500 screens May 15.',
    ...
    urgent: 'FILM FINANCE & EQUITY ACCESS',
    urgency: true,
    timeSensitive: true,
    timeSensitiveLabel: 'Finished · Delivered · Releasing May 15 · $2M Tranche Only',
    status: 'Funding Open',
    statusColor: 'var(--red-urgent)',
    ...
    stats: 'Budget: $73.8M | Release: May 15 | 3,500 Screens | Ask: $2M',
    pos: 'Position: Film Finance & Equity Access — Lifetime Profit Participation',
    budget: '$73.8M',
    equityAvailable: '$2,000,000 primary equity access',
    investmentAsk: '$2,000,000 USD',
    position: 'Film Finance & Equity Access',
    returnTarget: 'Lifetime profit participation on the $2M Film Finance & Equity Access position. Participation is open through Stanford Emporium Inc.',
    targetROI: 'Lifetime Profit Participation · Open Through Stanford Emporium Inc.',
    taxIncentives: 'Documented cost basis of $1.5M provides path to tax-free return. Finance plan: $49.4M senior lending against international pre-sales and tax credits. Fully structured.',
    ...
    investmentNote: 'This is a finished, delivered asset. Film Finance & Equity Access — $2,000,000 USD with lifetime profit participation. Finder\'s fee paid by assignor. Maximum available: $2,000,000 this tranche only. Minimum commitment: $250,000. Participation is open through Stanford Emporium Inc.',
    ...
    positioning: 'A finished, delivered Guy Ritchie action thriller. $2M Film Finance & Equity Access. Lifetime profit participation. Lionsgate releasing on 3,500 screens May 15.',
    budgetRange: '$73.8M',
    ...
    timingRelevance: 'Film is finished and releasing May 15 on 3,500 screens. $2M tranche only — minimum $250K. Lifetime participation open through Stanford Emporium Inc. Finder\'s fee paid by assignor.',
    commercialStrengths: [
      ...
      'Lifetime profit participation on the $2M Film Finance & Equity Access position.',
      '$23M projected opening weekend · $60M domestic total.',
      'Break-even at $17.5M — film is projected to open above break-even on day one.',
  ...
  },
  {
    ...
    image: '/lost-book-poster.jpg',
    heroImage: '/lost-book-poster.jpg',
    description: 'Two archaeologists set out to find the legendary Lost Book of Creation — which contains the answer to why we exist. A global four-quadrant franchise in the vein of The Mummy and National Treasure, with a modern conspiracy edge.',
    logline: 'Two archaeologists race across the world to uncover the Lost Book of Creation — an ancient text said to contain the answer to humanity\'s most profound question: why do we exist?',
    ...
    dataRoomUrl: '',
    dataRoomGatedPath: '',
    previewImages: ['/lost-book-poster.jpg'],
    team: [
