...
export const PROJECTS: Project[] = [
  {
    ...
    description: 'Power builds empires. Loyalty destroys them. A gangster crime film set against the opulent landscapes of Tuscany — where old-world loyalties collide with modern ambition, and the cost of betrayal is measured in blood and concrete.',
    status: 'Funding Open',
    timeSensitive: true,
    timeSensitiveLabel: 'Investment Open · Gangster Crime · Tuscany',
    urgent: 'INVESTMENT OPEN',
    details: 'Stanford Emporium Inc. is presenting Once Upon a Time in Tuscany as an investment opportunity. Directed by Benjamin Johns, this gangster crime feature is positioned for international theatrical release with a compelling ensemble and cinematic scope. Contact Stanford Emporium Inc. to receive the full investment deck and terms.',
    ...
    logline: 'Power builds empires. Loyalty destroys them. A gangster crime film where old-world loyalties and new ambition collide in the hills of Tuscany.',
