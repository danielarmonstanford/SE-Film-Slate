...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    description: 'A finished, delivered Guy Ritchie action thriller with a $1M refinancing opportunity offering a documented 50% return. Lionsgate releasing on 3,500 screens May 15.',
    ...
    urgent: 'REFINANCE OPPORTUNITY',
    urgency: true,
    timeSensitive: true,
    timeSensitiveLabel: 'Finished · Delivered · Releasing May 15 · $1M Tranche Only',
    status: 'Funding Open',
    statusColor: 'var(--red-urgent)',
    ...
    stats: 'Budget: $73.8M | Release: May 15 | 3,500 Screens | Ask: $1M',
    ...
    returnTarget: '50% documented return at assignment close. Full lifetime profit participation on $1.5M position.',
    targetROI: '50% Documented Return at Assignment Close · 8-Month Recoupment Target',
    ...
    investmentNote: 'This is a finished, delivered asset. You invest $1M. Documented cost basis is $1.5M — 50% return built in at close. Upside calculated on full $1.5M position. Finder\'s fee paid by assignor. Maximum available: $1,000,000 this tranche only. Minimum commitment: $250,000.',
    ...
    positioning: 'A finished, delivered Guy Ritchie action thriller. $1M refinance. 50% documented return at close. Lionsgate releasing on 3,500 screens May 15.',
    budgetRange: '$73.8M',
    ...
    timingRelevance: 'Film is finished and releasing May 15 on 3,500 screens. $1M tranche only — minimum $250K. 8-month recoupment target. Finder\'s fee paid by assignor.',
    commercialStrengths: [
      ...
      '50% return documented at cost basis close — more than double the standard 20% primary equity premium.',
