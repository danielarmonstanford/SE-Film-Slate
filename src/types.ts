...
export const PROJECTS: Project[] = [
  {
    ...
    details: "Dir: Harvey Lowry | Prod: Bryan Lord (M-World Films) | A modern-day retelling of The Swiss Family Robinson.",
    stats: 'Dir. Harvey Lowry · M-World Films · Budget ~$6.6M',
    pos: 'Position: Equity Investment — Terms to be confirmed',
    number: '012',
    shortTitle: 'The Robinsons',
    director: 'Harvey Lowry',
    talent: 'Casting under consideration — William: Greg Kinnear / Dennis Quaid / Bobby Cannavale · Boone: Ian McShane / Ben Kingsley / Timothy Olyphant · Elizabeth: January Jones / Emmanuelle Chriqui / Yvonne Strahovski',
    ...
    timingRelevance: 'Project in packaging — cast attachments and financing structure currently being finalized. Contact Stanford Emporium Inc. for the full deck and latest status.',
    commercialStrengths: [
      ...
      'Multiple A-list casting options under consideration across all three lead roles.',
  ...
  },
  {
    ...
    description: 'Exclusive through Stanford Emporium Inc. — up to $1,000,000 in Lifetime Participation Shares now available in a finished, delivered Guy Ritchie action thriller. Minimum fixed return of $1.5M in 6–12 months.',
    ...
    urgency: true,
    timeSensitive: true,
    timeSensitiveLabel: 'Exclusive · Up to $1M · Fixed $1.5M Return · 6–12 Months',
    status: 'Funding Open',
    statusColor: 'var(--red-urgent)',
    ...
    stats: 'Budget: $73.8M | Up to $1M Available | Fixed $1.5M Return | 6–12 Months',
    pos: 'Position: Lifetime Participation Shares — Exclusive Through Stanford Emporium Inc.',
    budget: '$73.8M',
    equityAvailable: 'Up to $1,000,000 — Lifetime Participation Shares',
    investmentAsk: 'Up to $1,000,000 (Inquiry)',
    ...
    investmentNote: 'Exclusive through Stanford Emporium Inc. Up to $1,000,000 in Lifetime Participation Shares available. Fixed minimum return of $1,500,000 in 6–12 months. Contact Stanford Emporium Inc. for contractual agreements.',
    ...
    positioning: 'Exclusive through Stanford Emporium Inc. — up to $1,000,000 in Lifetime Participation Shares in a finished, delivered Guy Ritchie action thriller. Fixed minimum return of $1,500,000 in 6–12 months.',
    budgetRange: '$73.8M',
    ...
    timingRelevance: 'Exclusive through Stanford Emporium Inc. Up to $1,000,000 in Lifetime Participation Shares available. Fixed minimum return of $1,500,000 in 6–12 months. Contact Stanford Emporium Inc. for contractual agreements.',
    commercialStrengths: [
      'EXCLUSIVE through Stanford Emporium Inc. — up to $1,000,000 in Lifetime Participation Shares.',
