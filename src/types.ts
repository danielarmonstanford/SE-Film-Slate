...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    urgency: true,
    subStatus: 'Shoot: 1 Week Georgia · 3 Weeks Malta',
    deckUrl: 'https://drive.google.com/file/d/1_placeholder_deck_link/view?usp=sharing',
    previewImages: [
      '/film-99-poster.png',
    ],
    positioning: '$10M action thriller shooting one week in Georgia and three weeks in Malta. $3M equity opportunity now open — Senior Preferred, LIFO structure.',
    budgetRange: '$10M',
    equityAvailable: '$3M — Senior Preferred Equity · Live Opportunity',
    taxIncentives: 'Georgia Film Tax Credit 30% · Malta Film Rebate 40%',
