...
export const PROJECTS: Project[] = [
  ...
  },
  {
    ...
    urgent: 'EXTREMELY URGENT',
    details: 'Dir: Colin Broderick | EP: Sawyer Spielberg · Bill Strauss',
    ...
    marketPositioning: "Goldcrest Pictures NY production entity. WGA/DGA/SAG/IATSE. 27-day shoot commencing April 20, 2026.\n\nTalent: Sawyer Spielberg (son of Steven Spielberg) · Melissa Leo (Oscar Winner) · Michael Kelly · Liam Neeson (negotiating) · Josh Brolin (negotiating) · Lily James (negotiating).\n\nEP: Sawyer Spielberg · Bill Strauss (Straight Outta Compton). Strong pre-sales potential anchored by Neeson attachment. The NY 30% tax credit reduces effective investor exposure to $12.5M net — $4.4M rebate is audit-budgeted and structured.",
    ...
    commercialStrengths: [
      'Liam Neeson negotiating — proven $100M+ international box office anchor.',
      'Josh Brolin and Lily James also in negotiation — ensemble with global theatrical draw.',
      ...
      'Sawyer Spielberg as EP — industry access and distribution relationship depth.',
    ...
    team: [
      ...
      { role: 'Cast (negotiating)', name: 'Josh Brolin' },
